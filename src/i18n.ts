...
export const ENGLISH_TRANSLATIONS = {
  ...
  "status.computingEmbeddings": "Auto LLM Wiki: computing embeddings...",
  ...
  "notice.noActiveProvider": "No active provider configured. Add one in Auto LLM Wiki settings.",
  ...
  "error.noVisionProvider": "No vision provider configured. Add a vision-capable provider in Auto LLM Wiki settings.",
  ...
  "command.pushWiki": "Push Auto LLM Wiki changes",
...
const ZH_TRANSLATIONS: Partial<TranslationTable> = {
  ...
  "error.noVisionProvider": "未配置视觉提供程序。请在 Auto LLM Wiki 设置中添加一个支持视觉的提供程序。",
  ...
  "command.pushWiki": "推送 Auto LLM Wiki 变更",
